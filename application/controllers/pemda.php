...
if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class pemda extends CI_Controller {		
		...
		{			
			...
			$path			= "./upload/nota_dinas/".str_replace('/', '', $txt_no_nota);
			...
			$upload			= "/pemda/upload/nota_dinas/".str_replace('/', '', $txt_no_nota)."/";
		...
		{			
			if (isset($_FILES["myfile"])) {  
				...
				for ($i = 0; $i < $no_files; $i++) {					
					...
					$path			= "./upload/lampiran/".str_replace('/', '', $txt_no_nota);
					...
					$upload			= "/pemda/upload/lampiran/".str_replace('/', '', $txt_no_nota)."/";
		...
		function delete_dokumen()
		{
			...
			$dirFile		= $_SERVER['DOCUMENT_ROOT']."/pemda/upload/lampiran/".str_replace('/', '', $no_nota_dinas)."/".$file;
			
			unlink($dirFile);
			
			$data			= $this->pemda_model->delete_dokumen($no_nota_dinas, "/pemda/upload/lampiran/".str_replace('/', '', $no_nota_dinas)."/".$file);
